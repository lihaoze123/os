...
const R: MapPermission = MapPermission::R;
const W: MapPermission = MapPermission::W;
const X: MapPermission = MapPermission::X;
const U: MapPermission = MapPermission::U;
...
impl MemorySet {
    ...
    pub fn new_kernel() -> Self {
        ...
        map!(".text", stext, etext, R | X);
        map!(".rodata", srodata, erodata, R);
        map!(".data", sdata, edata, R | W);
